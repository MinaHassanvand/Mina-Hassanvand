...
#-------------------------------------------------------------------------------------------------------------
    ...
    def parkingDurationCalc(self, carType):
...
def instanceMaker(myInputs):
    if myInputs['carType'] == 1:
        instance = Car()
        instance.feeCalc(myInputs)
...
while True:
    ...
    if parkingInfoInputCarType(myInputs):
        ...
        carType.parkingDurationCalc(carType)
        instance = instanceMaker(myInputs)
        carType.parkingBill()
        carType.parkingLog()
    else:
        raise SystemExit
